    ...
    <div id = "divSettings">
      <div id = "divSettingsContent">
        ...
        <div class = "divOneSetting">
          Display number of stones in holes: 
          <img id = "imgDisplayNbStone" src = "./Img/toggleOff.gif"
            onClick = "SwitchDisplayNbStoneHole();"> 
          <span id ="spanDisplayNbStone">no</span>
        </div>
        <div class = "divOneSetting">
          Speed of animation: 
          <input type = "range" min = "0" max = "75" value = "0"
            id = "rngSpeedAnimation" onChange = "SetSpeedAnimation();">
        </div>
      </div>
    </div>
